...
public class ProductInfoPage {
	...
	private By productImageCount = By.cssSelector("div#content img");
	...
	{
		String productHeaderText =  eleUtil.doGetText(productHeaderName);
	...
	{
		return eleUtil.getElements(productImageCount).size();
	}
	
	public Map<String,String> getProductInfo()
	{
		productInfoMap = new LinkedHashMap<String,String>();
		String header = getProductHeader();
